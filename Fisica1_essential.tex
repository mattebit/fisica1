...
\begin{document}
  ...
  Tutti i grafici delle trasformazioni sopra convergono nello stesso punto del grafico, a $t_0 = -273,16°C$. Se prendo questo punto come origine del mio sistema di riferimento delle temperatura, avrò la scala delle temperature \textbf{assolute}, dove:
  $$0 K = -273,16 °C$$
